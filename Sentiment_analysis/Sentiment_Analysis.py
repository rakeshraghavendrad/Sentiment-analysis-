...
url = 'http://dev.ibridge360.com/api/UserAnswersAndScores/getFilenames'
...
for l in range(len(filename1)):
    path2 = "C:/Users/arohalap/OneDrive/AIML/Comm fee/Voice_Voice/"
    s3.download_file('ibridge',filename1[l],path2+filename1[l])
print("videos are downloded ")
# DATA Analysis Part
global a
path = 'C:/Users/arohalap/OneDrive/AIML/Comm fee/Voice_Voice/videos/'
path1 = "C:/Users/arohalap/OneDrive/AIML/Comm fee/Voice_Voice/aud/"    
...
#----------------------------DELETING ALL VIDEO AND AUDIO FROM LOCAL DIR-------------------------------------------#
    folder = 'C:/Users/arohalap/OneDrive/AIML/Comm fee/Voice_Voice/videos'
    ...
    import os, shutil
    folder1 = 'C:/Users/arohalap/OneDrive/AIML/Comm fee/Voice_Voice/aud'
